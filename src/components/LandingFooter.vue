<template>
  <footer class="bg-zinc-50 text-surface/75 dark:bg-purple-900 dark:text-white/75 lg:text-left">
    ...
    <!-- Copyright section -->
    <div class="bg-black/5 p-6 text-center dark:bg-white/5">
      <span>© 2024 Copyright:</span>
      <a class="font-semibold" href="#">Share2Teach</a>
    </div>
  </footer>
</template>
